...
package com.github.obsessive.simplereader.widgets;
...
public class PlayerDiscView extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        mNeedle = findViewById(R.id.player_needle);
        mAlbumCover = findViewById(R.id.player_disc_image);
        mDiscLayout = findViewById(R.id.player_disc_container);
